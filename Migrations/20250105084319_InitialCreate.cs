...
namespace eConcours.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnneUni3 = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "test5", false, "saada", "test5", false, false, new DateTime(2025, 1, 5, 9, 43, 19, 112, DateTimeKind.Local).AddTicks(1947), new DateTime(2025, 1, 5, 9, 43, 19, 112, DateTimeKind.Local).AddTicks(1982), "xxxs@gmail.com", "ghh", 1, null, "A123", "Marocaine", 3, "xxxx", 0.0, 0, "test", "icon.jpg", "xxx", false, "Femme", null, 1, "Casablanca", false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "test5", "2020/2021", "2022/2023", "2023/2024", "Non", "Non", "Non", 14.199999999999999, 14.800000000000001, 15.0, 17.0, 0.0, 0.0 });
