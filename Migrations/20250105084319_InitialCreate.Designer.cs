...
namespace eConcours.Migrations
{
    ...
    [Migration("20250105084319_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eConcours.Models.Admin", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eConcours.Models.AnneeUniversitaire", b =>
                {
            ...
            modelBuilder.Entity("eConcours.Models.Baccalaureat", b =>
                {
                    b.Property<string>("Cne")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("eConcours.Models.Candidat", b =>
                {
                    b.Property<string>("Cne")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Conforme = false,
                            Convoque = false,
                            DateInscription = new DateTime(2025, 1, 5, 9, 43, 19, 112, DateTimeKind.Local).AddTicks(1947),
                            DateNaissance = new DateTime(2025, 1, 5, 9, 43, 19, 112, DateTimeKind.Local).AddTicks(1982),
            ...
            modelBuilder.Entity("eConcours.Models.ConcourEcrit", b =>
                {
                    b.Property<string>("Cne")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("eConcours.Models.ConcourOral", b =>
                {
                    b.Property<string>("Cne")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("eConcours.Models.ConfigurationPreselection", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eConcours.Models.ConfigurationSelection", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eConcours.Models.Corbeille", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eConcours.Models.Diplome", b =>
                {
                    b.Property<string>("Cne")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("eConcours.Models.Epreuves", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eConcours.Models.Fichier", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eConcours.Models.Filiere", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eConcours.Models.AnneeUniversitaire", b =>
                {
                    b.HasOne("eConcours.Models.Candidat", "Candidat")
                        .WithOne("AnneeUniversitaire")
                        .HasForeignKey("eConcours.Models.AnneeUniversitaire", "Cne")
            ...
            modelBuilder.Entity("eConcours.Models.Baccalaureat", b =>
                {
                    b.HasOne("eConcours.Models.Candidat", "Candidat")
                        ...
                        .HasForeignKey("eConcours.Models.Baccalaureat", "Cne")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("eConcours.Models.Candidat", b =>
                {
                    b.HasOne("eConcours.Models.Filiere", "Filiere")
                        .WithMany("Candidats")
                        .HasForeignKey("ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("eConcours.Models.ConcourEcrit", b =>
                {
                    b.HasOne("eConcours.Models.Candidat", "Candidat")
                        ...
                        .HasForeignKey("eConcours.Models.ConcourEcrit", "Cne")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("eConcours.Models.ConcourOral", b =>
                {
                    b.HasOne("eConcours.Models.Candidat", "Candidat")
                        ...
                        .HasForeignKey("eConcours.Models.ConcourOral", "Cne")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("eConcours.Models.Diplome", b =>
                {
                    b.HasOne("eConcours.Models.Candidat", "Candidat")
                        .WithOne("Diplome")
                        .HasForeignKey("eConcours.Models.Diplome", "Cne")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
