...
namespace eConcours.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(GestionConcourCoreDbContext _context, IFiche fiche, ICandidatService candidat_service, IEpreuveService epreuve, IWebHostEnvironment hostingEnvironment)
        {
        ...
        public IActionResult Download(string filename)
        {
            ...
            var path0 = Path.Combine(hostingEnvironment.ContentRootPath, "epreuves");
